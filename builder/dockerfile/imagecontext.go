...
type getAndMountFunc func(string, bool, string) (builder.Image, builder.ReleaseableLayer, error)
...
func newImageSources(ctx context.Context, options builderOptions) *imageSources {
	getAndMount := func(idOrRef string, localOnly bool, osForPull string) (builder.Image, builder.ReleaseableLayer, error) {
